...
Incluez les images dans le dossier \texttt{screenshots/} puis référencez-les ici ou référencez des annexes (figure \ref{abc}) :
\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\textwidth]{screenshots/get-users.png}
  \caption{Résultat du test (exemple)}
\end{figure}
