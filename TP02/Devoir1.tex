...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\textwidth]{Screen/connexion.png}
  \caption{Page de connexion}
\end{figure}

\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\textwidth]{Screen/USER_JSON.png}
  \caption{Liste des utilisateurs via GET /api/users}
\end{figure}

\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\textwidth]{Screen/db.png}
  \caption{Conception de la DB}
\end{figure}

\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\textwidth]{Screen/delet.png}
  \caption{Suppression d'un utilisateur via DELETE /api/users/:id}
\end{figure}
\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\textwidth]{Screen/usersHTML.png}
