...
describe("User Registration Validator", () => {
    ...
    it("devrait lancer une erreur si age n'est pas un nombre valide", () => {
        expect(() => validateUserRegistration("dix", "user", "test@test.com")).toThrow("Âge invalide");
    });
    // Age > 120
    it("devrait lancer une erreur si age > 120", () => {
        expect(() => validateUserRegistration(1000, "user", "test@test.com")).toThrow("Âge invalide");
    });
    // Role invalide
    it("devrait lancer une erreur si role invalide", () => {
        expect(() => validateUserRegistration(25, "chef des troupes", "test@test.com")).toThrow("Rôle invalide");
    });
    ...
    it("devrait accepter un admin valide", () => {
        expect(validateUserRegistration(40, "admin", "admin@test.com")).toBe(true);
    });
    // ----- facultatif pour tester les ages extremes  ----
    // Age limite 18
    it("devrait accepter age 18", () => {
        expect(validateUserRegistration(18, "user", "test@test.com")).toBe(true);
    });
    // Age limite 120
